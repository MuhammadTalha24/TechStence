                    ...
                    <div className="col-md-4">
                        <div className="card h-100 shadow-sm">
                            <div className="card-body">
                                ...
                                <p className="card-text">Custom websites and web applications built with the latest technologies.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="card h-100 shadow-sm">
                            <div className="card-body">
                                ...
                                <h3 className="card-title h5">Mobile Apps</h3>
                    ...
                    <div className="col-md-4">
                        <div className="card h-100 shadow-sm">
                            <div className="card-body">
                                ...
                                <p className="card-text">SEO, social media marketing, and digital advertising strategies.</p>
                            </div>
                        </div>
                    </div>
                </div>
